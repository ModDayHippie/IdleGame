#credit for base code goes to EldonWilliams
# Imports
...
while True:
    ...
    if coins >= worker_cost and shown_buy == False:
        clear()
        print(
            "You now have {} coins!\nYou can now buy more items to increase your productivity.\nTo open your buy menu run the command '/b'".format(
                coins))
    ...
    if run_arg == "/h":
        ...
        while True:
            ...
            print("[id: 2] Houses ({} coins)".format(House_Cost))
            print("[id: 3] Health ({} coins)".format(Health_Cost))
            if first_buy:
            ...
            if id == "/e":
                ...
                while True:
                    ...
                    if number * worker_cost <= coins:
                        ...
                        ref = ""
                        break
            #this is to buy a second item
            elif id == "2" and coins >= worker_cost:
                while True:
                    clear()
                    print("How many Houses would you like to purchase?")
                    number = input("# ")
                    if number == "max":
                        number = math.floor(coins // House_Cost)
                    else:
                        try:
                            number = int(number)
                        except:
                    ...
                    if number * House_Cost <= coins:
                        coins -= number * House_Cost
                        Houses += number
                        ref = "close"
                        break
                    else:
                        ...
                        ref = ""
                        break
            elif id == "3" and coins >= worker_cost:
                while True:
                    clear()
                    print("How many Health packs would you like to purchase?")
                    number = input("# ")
                    if number == "max":
                        number = math.floor(coins // Health_Cost)
                    else:
                        try:
                            number = int(number)
                        except:
                    ...
                    if number * Health_Cost <= coins:
                        coins -= number * Health_Cost
                        Health += number * 2
                        ref = "close"
                        break
                    else:
    ...
    #this is the boss battle logistics
    elif run_arg == "/boss":
        Boss_Rng = random.randint(0, 100)
        if Boss_Rng > 69:
            print("you failed to attack the boss")
            Health -= Boss_Attack * (resets + 1)
        elif Boss_Rng < 69:
            print("you attacked the boss and gained 200 coins")
            coins += 200
